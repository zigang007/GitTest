	...
	<form class="form-horizontal" 
					...
					<tr>
						<td>
							<select class="form-control" name="meeting_type">
								<option value="1">我参加的会议</option>
								<option value="2">我提交的会议</option>
							</select>
						</td>
					   <td>
						<input name="notice_title" type="text" class="form-control"
							placeholder="会议主题"  value = "${meeting.meeting_title}" >
						</td>
 		...
 		<div class="panel panel-primary" style="padding-left: 10px;">
 			<div class="panel-heading" style="background-color: #11a9e2;">
				<h3 class="panel-title">我的会议列表信息</h3>
			</div>
